#ifndef DOTLINESMARKERS_H
#define DOTLINESMARKERS_H
...
class DotLinesMarkers : public QWidget
{
    Q_OBJECT
public:
    explicit DotLinesMarkers(QWidget *parent = nullptr) : QWidget{parent}
    {
        for (int i = 0; i < 5; ++i)
