#ifndef DEFAULTCIRCLEDIAG_H
#define DEFAULTCIRCLEDIAG_H
...
class DefaultCircleDiag : public QWidget
{
    Q_OBJECT
public:
    explicit DefaultCircleDiag(QWidget *parent = nullptr) : QWidget{parent}
    {
        for (int i = 0; i < 5; ++i)
