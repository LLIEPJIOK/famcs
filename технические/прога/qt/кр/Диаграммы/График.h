#ifndef DEFAULFGRAPH_H
#define DEFAULFGRAPH_H
...
class DefaulfGraph : public QWidget
{
    Q_OBJECT
public:
    explicit DefaulfGraph(QWidget *parent = nullptr) : QWidget{parent}
    {
        for (int i = 0; i < 5; ++i)
